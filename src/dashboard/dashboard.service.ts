    ...
    async getDashboardData(userId: string) {
        ...
        const recentMovements = [
            ...expenses.map(expense => ({
                ...
                creation_date: dayjs(expense.creation_date).format('DD-MM-YYYY'),
            ...
            ...incomes.map(income => ({
                ...
                creation_date: dayjs(income.creation_date).format('DD-MM-YYYY'),
            ...
            ...debts.map(debt => ({
                ...
                type: 'debt',
                amount: debt.amount,
                creation_date: dayjs(debt.creation_date).format('DD-MM-YYYY'),
